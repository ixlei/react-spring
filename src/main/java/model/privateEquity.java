...
public class privateEquity {
	...
	public void setPubMoneyMin(double publishMoneyMin) {
		this.publishMonyMin = publishMoneyMin;
	}
	...
	public void setInvestmentMinRequest(double d) {
		this.investmentMinRequest = d;
	}
	...
	public double getexitMintime() {
		return this.exitMintime;
	}
	
	public double getInvestmentReq() {
